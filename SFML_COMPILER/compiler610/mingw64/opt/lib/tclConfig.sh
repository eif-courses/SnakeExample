...
# installed.
TCL_PREFIX='/c/mingw610/x86_64-610-posix-seh-rt_v5/mingw64/opt'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='/c/mingw610/x86_64-610-posix-seh-rt_v5/mingw64/opt'
...
# build directory.
TCL_BUILD_LIB_SPEC='-L/c/mingw610/x86_64-610-posix-seh-rt_v5/build/tcl8.6.4/win -ltcl86'

# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='-L/c/mingw610/x86_64-610-posix-seh-rt_v5/mingw64/opt/lib -ltcl86'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-I/c/mingw610/x86_64-610-posix-seh-rt_v5/mingw64/opt/include'
...
# compiled.
TCL_SRC_DIR='/c/mingw610/src/tcl8.6.4'

# List of standard directories in which to look for packages during
# "package require" commands.  Contains the "prefix" directory plus also
# the "exec_prefix" directory, if it is different.
TCL_PACKAGE_PATH='/c/mingw610/x86_64-610-posix-seh-rt_v5/mingw64/opt/lib'
...
# build directory.
TCL_BUILD_STUB_LIB_SPEC='-L/c/mingw610/x86_64-610-posix-seh-rt_v5/build/tcl8.6.4/win -ltclstub86'

# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-L/c/mingw610/x86_64-610-posix-seh-rt_v5/mingw64/opt/lib -ltclstub86'

# Path to the Tcl stub library in the build directory.
TCL_BUILD_STUB_LIB_PATH='/c/mingw610/x86_64-610-posix-seh-rt_v5/build/tcl8.6.4/win/libtclstub86.a'

# Path to the Tcl stub library in the install directory.
TCL_STUB_LIB_PATH='/c/mingw610/x86_64-610-posix-seh-rt_v5/mingw64/opt/lib/libtclstub86.a'
