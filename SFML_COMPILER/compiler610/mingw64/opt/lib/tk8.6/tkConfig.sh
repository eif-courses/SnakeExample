...
# installed.
TK_PREFIX='/c/mingw610/x86_64-610-posix-seh-rt_v5/mingw64/opt'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TK_EXEC_PREFIX='/c/mingw610/x86_64-610-posix-seh-rt_v5/mingw64/opt'
...
# build directory.
TK_BUILD_LIB_SPEC='-L/c/mingw610/x86_64-610-posix-seh-rt_v5/build/tk8.6.4/win -ltk86'

# String to pass to linker to pick up the Tk library from its
# installed directory.
TK_LIB_SPEC='-L/c/mingw610/x86_64-610-posix-seh-rt_v5/mingw64/opt/lib -ltk86'
...
# compiled.
TK_SRC_DIR='/c/mingw610/src/tk8.6.4'
...
# build directory.
TK_BUILD_STUB_LIB_SPEC='-L/c/mingw610/x86_64-610-posix-seh-rt_v5/build/tk8.6.4/win -ltkstub86'

# String to pass to linker to pick up the Tk stub library from its
# installed directory.
TK_STUB_LIB_SPEC='-L/c/mingw610/x86_64-610-posix-seh-rt_v5/mingw64/opt/lib -ltkstub86'

# Path to the Tk stub library in the build directory.
TK_BUILD_STUB_LIB_PATH='/c/mingw610/x86_64-610-posix-seh-rt_v5/build/tk8.6.4/win/libtkstub86.a'

# Path to the Tk stub library in the install directory.
TK_STUB_LIB_PATH='/c/mingw610/x86_64-610-posix-seh-rt_v5/mingw64/opt/lib/libtkstub86.a'
